...
pub struct NetworkForTransactionArgs {
    ...
    threshold_account_signature_options: crate::threshold_account_signature_options::SignWith,
}
...
pub struct NetworkForTransactionArgsContext {
    ...
    prepopulated_threshold_account: crate::commands::PrepopulatedThresholdAccount,
...
impl NetworkForTransactionArgsContext {
    pub fn from_previous_context(
        previous_context: crate::commands::ThresholdAccountActionContext,
        ...
        let network_config = network_connection
            ...
            .clone();
        let prepopulated_threshold_account =
...
impl From<NetworkForTransactionArgsContext> for crate::commands::ThresholdAccountContext {
    fn from(item: NetworkForTransactionArgsContext) -> Self {
        Self {
            global_context: item.global_context,
            network_config: item.network_config,
            prepopulated_threshold_account: item.prepopulated_threshold_account,
...
impl interactive_clap::FromCli for NetworkForTransactionArgs {
    type FromCliContext = crate::commands::ThresholdAccountActionContext;
        ...
        Self: Sized + interactive_clap::ToCli,
    {
        ...
        match <crate::threshold_account_signature_options::SignWith as interactive_clap::FromCli>::from_cli(
                clap_variant.threshold_account_signature_options.take(),
                new_context.into(),
            ) {
                ...
                interactive_clap::ResultFromCli::Err(optional_cli_sign_with, err) => {
                    clap_variant.threshold_account_signature_options = optional_cli_sign_with;
...
impl NetworkForTransactionArgs {
    fn input_network_name(
        context: &crate::commands::ThresholdAccountActionContext,
    ...
    pub fn get_sign_option(&self) -> crate::threshold_account_signature_options::SignWith {
        self.threshold_account_signature_options.clone()
    }
}
