...
pub struct Round1 {
    ...
    /// Select network
    network_config: crate::network_for_frost_round1::NetworkForTransactionArgs,
}

#[derive(Clone)]
pub struct Round1Context(crate::commands::FrostRound1ActionContext);
...
impl Round1Context {
    pub fn from_previous_context(
        ...
        let on_after_getting_network_callback: crate::commands::OnAfterGettingNetworkCallbackFrostRound1 =
            std::sync::Arc::new({
                ...
                move |_network_config| {
                    Ok(crate::commands::FrostRound1 { signer_id: signer_id.clone() })
                }
            });

        Ok(Self(crate::commands::FrostRound1ActionContext {
...
impl From<Round1Context> for crate::commands::FrostRound1ActionContext {
