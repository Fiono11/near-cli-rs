...
#[derive(Clone)]
struct Round2Context(SaveImplicitAccountContext);

impl Round2Context {
    pub fn from_previous_context(
        previous_context: crate::GlobalContext,
        _scope: &<Round2 as interactive_clap::ToInteractiveClapContextScope>::InteractiveClapContextScope,
...
impl From<Round2Context> for SaveImplicitAccountContext {
